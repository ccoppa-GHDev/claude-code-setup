...
description: Face-swap YouTube thumbnails to feature your face using AI image generation. Use when user asks to recreate thumbnails, face swap images, generate YouTube thumbnails, or create thumbnail variations.
...
## Goal
Face-swap YouTube thumbnails to feature your face using Gemini image model. The system analyzes face direction, matches reference photos by pose, and generates variations.
...
```bash
# Drop 30-40 photos of yourself into raw folder
...
Creates files like:
- `[YOUR_NAME]_yawL30_pitchU10.jpg` — looking 30° left, 10° up
- `[YOUR_NAME]_yawR45_pitch0.jpg` — looking 45° right, level
